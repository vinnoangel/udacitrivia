...
Error handler
"""
def errorHandler(error_code, message):
    return jsonify({
        "success": False,
...
def create_app(test_config=None):
    ...
    def get_quizzes():
        ...
        try:
            ...
            And as such should not contain any value when quiz category is empty
            """
    ...
    def not_found(error):
        return errorHandler(400, "bad request")

    @app.errorhandler(404)
    def not_found(error):
        return errorHandler(404, "resource not found")
    ...
    def not_found(error):
        return errorHandler(409, "request conflicts")
        
    @app.errorhandler(422)
    def not_found(error):
        return errorHandler(422, "unprocessable")
